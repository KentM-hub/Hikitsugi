...
# CPU creation
CPUClass = X86O3CPU if args.cpu_type == "X86O3CPU" else X86TimingSimpleCPU
system.cpu = CPUClass()

if args.fast_forward:
    system.fast_forward_cpu = CPUClass()
    system.fast_forward_cpu.max_insts_any_thread = args.fast_forward
    system.fast_forward_cpu.progress_interval = args.fast_forward / 10
